...
<body style="background-image: url(bg.png);" >
	...
	<tr>
	<th> <p><a href='index.php'>Keluar</a></p> </th><th> </th> <th> <p><a href='tambah_data.php'>Tambah Data</a></p> </th>
	</tr>
    <tr>
    ...
    while($user_data = mysqli_fetch_array($result)) {         
		...
		echo "<td><hr><a href='detail.php?id={$user_data['id_mhs']}'>Lihat Profil</a> <hr> <a href='hapus.php?id={$user_data['id_mhs']}'>Hapus Data </a><hr> </td>";
